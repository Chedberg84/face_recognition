...
chris_image = face_recognition.load_image_file("../../face_recognition_hedberg_pics/known/Chris.jpg")
chris_face_encoding = face_recognition.face_encodings(chris_image)[0]

stevie_image = face_recognition.load_image_file("../../face_recognition_hedberg_pics/known/Stevie.jpg")
stevie_face_encoding = face_recognition.face_encodings(stevie_image)[0]

alexis_image = face_recognition.load_image_file("../../face_recognition_hedberg_pics/known/Alexis.jpg")
alexis_face_encoding = face_recognition.face_encodings(alexis_image)[0]

fiona_image = face_recognition.load_image_file("../../face_recognition_hedberg_pics/known/Fiona.jpg")
fiona_face_encoding = face_recognition.face_encodings(fiona_image)[0]

oliver_image = face_recognition.load_image_file("../../face_recognition_hedberg_pics/known/Oliver.jpg")
