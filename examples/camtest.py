...
chris_image = face_recognition.load_image_file("../../face_recognition_hedberg_pics/Chris.jpg")
chris_face_encoding = face_recognition.face_encodings(chris_image)[0]

stevie_image = face_recognition.load_image_file("../../face_recognition_hedberg_pics/Stevie.jpg")
stevie_face_encoding = face_recognition.face_encodings(stevie_image)[0]

alexis_image = face_recognition.load_image_file("../../face_recognition_hedberg_pics/Alexis.jpg")
alexis_face_encoding = face_recognition.face_encodings(alexis_image)[0]

fiona_image = face_recognition.load_image_file("../../face_recognition_hedberg_pics/Fiona.jpg")
fiona_face_encoding = face_recognition.face_encodings(fiona_image)[0]

oliver_image = face_recognition.load_image_file("../../face_recognition_hedberg_pics/Oliver.jpg")
